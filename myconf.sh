...
cmake -S. -Bwasm --trace-source=CMakeLists.txt --trace-source=python.cmake --debug-output \
    -DBUILD_PYTHON=ON -DUSE_COINOR=OFF -USE_SCIP=OFF -DBUILD_SAMPLES=OFF -DBUILD_EXAMPLES=OFF -DBUILD_TESTING=OFF \
    ...
    -DCMAKE_TOOLCHAIN_FILE=/home/mergz/or-tools-wasm/pyodide/pyodide-build/pyodide_build/tools/cmake/Modules/Platform/Emscripten.cmake 2>&1 | tee wasmconf.log